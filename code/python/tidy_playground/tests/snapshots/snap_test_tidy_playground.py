...
snapshots['test_actions_for_expired_object 1'] = [
    {
        ...
        'sql': 'ALTER STAGE "PLAY"."GROUND"."AWS_STAGE" SET TAG PLAY.ADMINISTRATION.EXPIRY_DATE = \'2023-05-23\''
    },
    {
        'action': 'ALTER_EXPIRY_DATE',
        'reason': 'Expiry tag date is more than 90 days in the future.',
...
snapshots['test_actions_for_expired_object 2'] = [
    ...
    '{"sql": "DROP TABLE \\"PLAY\\".\\"GROUND\\".\\"R2_TBL\\"", "action": "DROP_OBJECT", "object_type": "BASE_TABLE", "status": "EXPIRED_OBJECT", "reason": "Expiry date for object has passed", "justification": {"age": 7, "days_since_last_alteration": 7.0, "expiry_date": null}, "cmd_result": "DRY_RUN"}',
    '{"sql": "ALTER TABLE \\"PLAY\\".\\"GROUND\\".\\"MY_EXT_TBL\\" SET TAG PLAY.ADMINISTRATION.EXPIRY_DATE = \'2023-05-23\'", "action": "ALTER_EXPIRY_DATE", "object_type": "EXTERNAL_TABLE", "status": "ILLEGAL_TAG", "reason": "Expiry tag date is more than 90 days in the future.", "justification": {"age": 8, "days_since_last_alteration": 8.0, "expiry_date": "2024-01-01"}, "cmd_result": "DRY_RUN"}',
    '{"sql": "DROP TABLE \\"PLAY\\".\\"GROUND\\".\\"PUBLIC\\"", "action": "DROP_OBJECT", "object_type": "BASE_TABLE", "status": "EXPIRED_OBJECT", "reason": "Expiry date for object has passed", "justification": {"age": 8, "days_since_last_alteration": 8.0, "expiry_date": null}, "cmd_result": "DRY_RUN"}',
    '{"sql": "ALTER TABLE \\"PLAY\\".\\"GROUND\\".\\"ANGIE_TEST_TBL\\" SET TAG PLAY.ADMINISTRATION.EXPIRY_DATE = \'2023-05-23\'", "action": "ALTER_EXPIRY_DATE", "object_type": "BASE_TABLE", "status": "ILLEGAL_TAG", "reason": "Expiry tag date is more than 90 days in the future.", "justification": {"age": 8, "days_since_last_alteration": 8.0, "expiry_date": "2024-01-01"}, "cmd_result": "DRY_RUN"}',
    ...
    '{"sql": "ALTER STAGE \\"PLAY\\".\\"GROUND\\".\\"MY_INT_STAGE\\" SET TAG PLAY.ADMINISTRATION.EXPIRY_DATE = \'2023-05-23\'", "action": "ALTER_EXPIRY_DATE", "object_type": "INTERNAL_NAMED", "status": "ILLEGAL_TAG", "reason": "Expiry tag date is more than 90 days in the future.", "justification": {"age": 8, "days_since_last_alteration": 8.0, "expiry_date": "2024-01-01"}, "cmd_result": "DRY_RUN"}',
